...
public abstract class AbstractCommonCharacter extends AbstractPlayerCharacter {
     ...
     */
    protected AbstractCommonCharacter(final @NotNull String name, final int maxHp, final int defense, final @NotNull BlockingQueue<GameCharacter> turnsQueue) throws InvalidStatValueException {
